  ...
  async info(
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: "Joined Server", value: targetUser.joinedAt?.toLocaleDateString() || "Unknown", inline: true },
        { name: "Account Created", value: targetUser.user.createdAt.toLocaleDateString(), inline: true },
